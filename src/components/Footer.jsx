        ...
        <>
            ...
            <div className="bg-[#a98467] w-full">
                <div className="max-w-screen-2xl container mx-auto md:px-20">
                    <footer className="bg-[#a98467] text-black py-8">
                        <div className="max-w-screen-2xl container mx-auto px-6 md:px-20">
                            <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-8">
                                ...
                                <div className="text-center md:text-left text-sm space-y-2">
                                    ...
                                    <p>Email: praveenjangid5003@gmail.com</p>
                                    <p>Phone: +91 7665105003</p>
                                </div>
...
//             <div className="bg-[#a98467] w-full">
//                 <div className="max-w-screen-2xl container mx-auto md:px-20">
//                     <footer className="footer footer-center text-base-content rounded py-6 text-black">
